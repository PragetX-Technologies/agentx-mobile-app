...
import 'package:agentx/utils/utils.dart';
import 'package:agentx/utils/widgets/controls.dart';
import 'package:agentx/utils/widgets/participant.dart';
import 'package:agentx/utils/widgets/participant_info.dart';
  ...
  Widget build(BuildContext context) => Scaffold(
    body: Stack(
      children: [
        Column(
          children: [
            Expanded(child: participantTracks.isNotEmpty ? ParticipantWidget.widgetFor(participantTracks.first, showStatsLayer: true) : Container()),
            if (widget.room.localParticipant != null) SafeArea(top: false, child: ControlsWidget(widget.room, widget.room.localParticipant!)),
          ],
        ),
        Positioned(
          left: 0,
